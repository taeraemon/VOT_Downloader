...
VOT_DATASETS = {
    ...
    # "vots2023":"https://data.votchallenge.net/vots2023/dataset/description.json"
}
...
def download_dataset(name, path=".", existed=None):
    ...
    with Progress("Downloading", len(meta["sequences"])) as progress:
        for sequence in meta["sequences"]:
            ...
            print(sequence["annotations"]["url"])
...
if __name__ == '__main__':
    NAME = 'vot-st2018'
    SAVE_DIR = './dataset/VOT' # '/home/local_data/chenl/VOT/vots2023'
    # Existed_Seqs = ['animal','ants1','bag','basketball','basketball-11','beaker','bear-6','bicycle','bicycle-7','birds1',
    #                 'bird-2', 'bird-15', 'boat', 'bolt1', 'book', 'book-3', 'bottle', 'bubble', 'bull', 'bus', 'bus-2', 
    #                 'car', 'car-9'] # 'carchase'
